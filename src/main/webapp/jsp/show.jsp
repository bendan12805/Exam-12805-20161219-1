<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page
	import="exam.servlet.CustomerServlet,exam.bean.Film,java.util.* "%>
...
<body>
	<table border="1" cellspacing="0" cellpadding="5" bordercolor="silver"
		align="center">
		<tr>
			<td colspan="5" align="center" bgcolor="#E8E8E8">艺演万年影院影视表</td>
		</tr>
		<tr>
			<td>电影序号</td>
			<td>电影名字</td>
		...
		<%
			CustomerServlet ccs = new CustomerServlet();
